...
- **Abou LDAP:** users sign with AD; signing in the internal citizen view is possible. Rights in Abou users **or** AD groups synced into Abou groups (same names). Highest of user+group wins.
